...
<head>
    ...
    <body>
      <nav class="navbar" style="background-color: #A0D995; position: sticky; top: 0; z-index: 1000;">
...
<div class="container mt-5">
  <div class="custom-image-container">
    <img src="img/tutor.png" class="img-fluid custom-image" alt="Web Tutoring Image">
    <div>
      <h2 class="mt-5">WELCOME TO E-LEARNING</h2>
      <p class="lead">"Explore Endless Possibilities in Learning."</p>
      <!-- Learn More button -->
...
<div class="container" id="popular">
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center">
      ...
      <div class="card3 text-center">
        ...
        <div class="card3-body">
          ...
          <div class="ikon">
            ...
            <a href="mailto:elvaaprilitimang15@gmail.com">
            ...
            <a href="https://www.instagram.com/elva_timang">
        ...
        <p class="text-center mt-3">
            <a href="/" class="text-decoration-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor"
                    class="bi bi-arrow-up-circle-fill" viewBox="0 0 16 16" style="fill: #a3eeb8;">
                    <path
    ...
    <footer class="footer">
      &copy; 2023 Projek Akhir WEB - H071221076
  </footer>
